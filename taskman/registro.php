	...
	<?php   
		if (isset($_REQUEST['boton'])!=null) {
			...
			if ($_REQUEST['boton']=="registrar"){
				if ($_REQUEST['nombre']!=null || $_REQUEST['correo']!=null || $_REQUEST['user']!=null || $_REQUEST['contra']!=null || $_REQUEST['tipo_rol']!=null ) { 
					$var1=$_REQUEST['nombre'];
					$var2=$_REQUEST['correo'];
					$var3=$_REQUEST['user'];
					$var4=$_REQUEST['contra'];
					$var5=$_REQUEST['tipo_rol'];
					$query="INSERT INTO usuario(id_cliente,nombre,correo,user,pass,tipo) 
